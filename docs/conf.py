...
html_theme_options = {
    ...
    'extra_nav_links': {
        'invenio-sequencegenerator@GitHub': 'https://github.com/inveniosoftware/invenio-sequencegenerator',
        'invenio-sequencegenerator@PyPI': 'https://pypi.python.org/pypi/invenio-sequencegenerator/',
    }
}
